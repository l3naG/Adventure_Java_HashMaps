...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        tempExits.put("S", 4);
        tempExits.put("N", 5);
        locations.put(1, new Location(1, "You are standing at the end of the road before small brick building", tempExits));
        ...
        tempExits.put("S", 1);
        tempExits.put("W", 2);
        locations.put(5, new Location(5, "You are in a forrest", tempExits));
